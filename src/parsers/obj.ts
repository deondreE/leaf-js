...
export default class WebGPUOBJParser {
    ...
    async createBuffers() {
        const vertexData = new Float32Array(this.vertices.flatMap(v => [
    ...
    async createPipeline(shaderModule: GPUShaderModule, format: GPUTextureFormat, uniformBuffer: GPUBuffer) {
